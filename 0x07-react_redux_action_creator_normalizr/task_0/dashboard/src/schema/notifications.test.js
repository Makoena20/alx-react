...
// Test case for the user with id 5debd764a7c57c7839d722e9
describe('getAllNotificationsByUser', () => {
  it('should return notifications for user with id 5debd764a7c57c7839d722e9', () => {
    ...
    // Call the function with the specified userId
    const result = getAllNotificationsByUser('5debd764a7c57c7839d722e9');

    // Verify that the result matches the expected notifications using arrayContaining
